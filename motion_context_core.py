# Derived from NikoDemon80/ComfyUI-H3-Motion-Context; modified for standalone Auto-Chain use in 2026.
# Original copyright: NikoDemon80. This derived code remains GPLv3.
...
class AutoChainMotionContextCore:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
