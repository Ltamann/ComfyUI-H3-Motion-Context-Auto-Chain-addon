...
This file is derived from NikoDemon80/ComfyUI-H3-Motion-Context and was
modified for standalone use in the Auto-Chain addon in 2026. It remains
licensed under GPLv3; see THIRD_PARTY_NOTICES.md.
